...
<div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
    @if (Route::has('login'))
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
            @auth
                <a href="{{ route('admin.dashboard') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Site Admin</a>
            @else
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        <a href="/" class="flex justify-center">
            <img class="invert" src="https://staxogroup.com/content/uploads/2022/08/staxo-logo.svg" alt="Staxo">
        </a>
